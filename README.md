...
| Sign       | **Cryptographic digital signatures** — sign with your certificate (.p12/.pfx) and **verify** a signed PDF (integrity + signer identity); real PKCS#7, plus visual draw/type signatures |
